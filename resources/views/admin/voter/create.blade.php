...
@section('title', 'Tambahkan Data Pemilih')
        ...
        <div class="space-y-6">
            <div class="flex flex-col bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-6">
                <div class="bg-[#926AE1]/20 rounded-lg shadow-lg p-6">
                    <div class="">
                        <h1 class="text-2xl lg:text-3xl font-bold text-[#4F22AA] mb-2">Tambahkan Data Pemilih</h1>
                        <p class="text-sm text-[#4F22AA] lg:text-base">Tambahkan data pemilih baru ke dalam sistem.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center lg:items-start lg:text-left">
                    ...
                    <div class="w-full max-w-lg">
                        ...
                        <form action="{{ route('voter.store') }}" method="POST" onsubmit="validateForm(event)">
                            @csrf
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input placeholder="Masukkan Kelas" type="text" name="class"
                                            id="class"
                                            class="text-sm w-full h-14 pl-12 placeholder:text-gray-300 border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                            required autocomplete="off">
                                    </div>
