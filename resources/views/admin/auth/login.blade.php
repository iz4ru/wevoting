            ...
            <div class="w-full max-w-sm">
                <div class="bg-white/30 backdrop-blur-lg rounded-2xl shadow-lg p-8">
                    ...
                    <div class="text-left mb-4">
                        <img src="{{ asset('img/8-bit.png') }}" alt="Selamat Datang" class="w-16 h-16 object-contain" />
                    </div>
                    ...
                    <!-- Login Form -->
                    <div class="">
                        <form wire:submit='login' action="{{ route('admin.login') }}" method="POST"
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input wire:model="form.password" placeholder="Masukkan Password" type="password"
                            ...
                            <!-- Forgot Password -->
                            <div
                                class="space-y-4 mt-2 text-sm text-right text-[#7C3AED] hover:text-[#4F22AA] hover:underline">
