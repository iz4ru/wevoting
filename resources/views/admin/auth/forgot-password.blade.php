    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="p-6">
            <div class="flex items-center gap-6 px-8 py-4">
                <a href="{{ route('admin.login') }}" class="text-gray-600 hover:text-gray-800 transition-colors">
            ...
            <div class="w-full max-w-sm">
                <div class="bg-white/30 backdrop-blur-lg rounded-2xl shadow-lg p-8">
                    ...
                    <div class="text-left mb-4">
                        <img src="{{ asset('img/lock-key.png') }}" alt="Selamat Datang"
                    ...
                    <!-- Login Form -->
                    <div class="">
                        <form action="{{ route('password.email') }}" method="POST" onsubmit="validateForm(event)">
                            @csrf
                            <div class="space-y-4">
                                <div class="relative w-full">
                                    <i
                                        class="fa fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-300"></i>
                                    <input wire:model="form.email" placeholder="Masukkan Email" type="email"
                                        name="email" id="email"
                                ...
                                @if (session('success'))
                                    <div class="alert alert-success alert-dismissible fade show text-sm py-2 px-4 bg-green-100 text-green-500 border border-green-500 rounded-md"
                                ...
                                @if (session('error'))
                                    <div class="alert alert-error alert-dismissible fade show text-sm py-2 px-4 bg-red-100 text-red-500 border border-red-500 rounded-md"
                            ...
                            <div class="space-y-4 mt-4">
                                <button type="submit"
                                    ...
                                    <div class="text-center flex items-center gap-3">
                                        <span class="font-semibold">Kirim Link Verifikasi</span>
