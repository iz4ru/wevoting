                ...
                <div class="bg-white/30 backdrop-blur-lg rounded-2xl shadow-lg p-8">
                    ...
                    <div class="text-left mb-4">
                        <h1 class="text-4xl font-bold text-gray-700 mb-2">
                            Siap Untuk Memulai <br>  Pemilihan?
                        </h1>
                        <p class="text-md text-gray-500">
                            Ayo registrasi terlebih dahulu!
                        </p>
                    </div>

                    <!-- Register Form -->
                    <div class="">
                        <form wire:submit='register' action="{{ route('register.admin.store') }}" method="POST" onsubmit="validateForm(event)">
                            @csrf
                            <div class="space-y-4">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input wire:model="name" placeholder="Masukkan Nama Anda" type="text" name="name" id="name" 
