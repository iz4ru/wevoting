        ...
        <div class="space-y-6">
            <div class="flex flex-col bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-6">
                <div class="bg-[#926AE1]/20 rounded-lg shadow-lg p-6">
                    <div class="">
                        <h1 class="text-2xl lg:text-3xl font-bold text-[#4F22AA] mb-2">Update Data Posisi</h1>
                        <p class="text-sm text-[#4F22AA] lg:text-base">Lihat, perbarui informasi data posisi yang terdaftar dalam sistem.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center lg:items-start lg:text-left">
                    ...
                    <div class="w-full max-w-lg">
                        ...
                        <form wire:submit="updateProfileInformation" action="{{ route('position.update', $position->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input placeholder="Masukkan Nama Posisi" type="text" name="position_name"
                                            ...
                                            required autocomplete="off" value="{{ $position->position_name }}">
                                    </div>
                                </div>
