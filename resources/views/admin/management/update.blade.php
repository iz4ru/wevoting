            ...
            <div class="flex flex-col bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-6">
                <div class="bg-[#926AE1]/20 rounded-lg shadow-lg p-6">
                    <div class="">
                        ...
                        <p class="text-sm text-[#4F22AA] lg:text-base">Perbarui informasi admin atau panitia yang terdaftar dalam sistem.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center lg:items-start lg:text-left">
                    ...
                    <div class="w-full max-w-lg">
                        ...
                        <form wire:submit="updateProfileInformation" action="{{ route('admin.mgmt.update', $user->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="space-y-4">
